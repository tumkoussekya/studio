        ...
        <div className="grid md:grid-cols-[280px_1fr] gap-12">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <section id="getting-started" className="mb-16 scroll-mt-20">
              <h2 className="text-4xl font-extrabold tracking-wide text-foreground mb-4 font-headline">Getting Started</h2>
            ...
            <section id="virtual-world" className="mb-16 scroll-mt-20">
                <h2 className="text-3xl font-bold font-headline tracking-wide">Virtual World</h2>
             ...
             <section id="chat" className="mb-16 scroll-mt-20">
                <h2 className="text-3xl font-bold font-headline tracking-wide">Team Chat</h2>
             ...
             <section id="kanban" className="mb-16 scroll-mt-20">
                <h2 className="text-3xl font-bold font-headline tracking-wide">Kanban Board</h2>
             ...
             <section id="ai-assistant" className="mb-16 scroll-mt-20">
                <h2 className="text-3xl font-bold font-headline tracking-wide">AI Assistant "Alex"</h2>
